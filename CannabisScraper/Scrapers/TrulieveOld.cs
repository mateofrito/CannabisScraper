...
{
    public class TrulieveOld : IScraper
    {
        private readonly IWebDriver driver;
        private readonly WaitAssistant longWait;
        private readonly WaitAssistant tinyWait;

        public TrulieveOld(IWebDriver driver, WaitAssistant longWait, WaitAssistant tinyWait)
        {
            this.driver = driver;
        ...
        public List<CannabisData> ExecuteScrape(string url, List<CannabisData> cannabisData, string companyName, string location, string configFilePathAndName)
        {
            ...
            string nextBtnXpath = "//*[@id=\"main-content\"]/div[2]/div[2]/nav/button[2]";
            int pageCount = 1;
            ...
            Console.WriteLine($"Beginning scrape for {pageCount} of the {categoryName} category.");
            ...
            while (true)
            {
                ...
                IWebElement nextButton = driver.FindElement(By.XPath(nextBtnXpath));
                bool isDisabled = nextButton.GetAttribute("disabled") != null;
